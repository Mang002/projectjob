...
const healthDetail = ({ route }) => {
  ...
  const fetchFoodData = async () => {
    try {
      const response = await fetch(`${API_URL}/health.php?id=${healthId}`);
  ...
  const fetchComments = async () => {
    try {
      const response = await fetch(`${API_URL}/comments_health.php?id=${healthId}`);
      const data = await response.json();
      setComments(data);
  ...
  const fetchLikes = async () => {
    try {
      const response = await fetch(`${API_URL}/like_health.php?id=${healthId}`);
      const data = await response.json();
      setLikes(data.likes);
    } catch (error) {
  ...
  const handleLike = async () => {
    try {
      ...
      const response = await fetch(
        `${API_URL}/likes_health.php?id=${healthId}&uid=${userId}`,
        {
          method: "POST",
        }
      );
  ...
  const handleAddComment = async () => {
    if (comment.trim()) {
      try {
        const userId = await AsyncStorage.getItem("id");
        const response = await fetch(
          `${API_URL}/add_comhealt.php?id=${healthId}&uid=${userId}`,
          {
            method: "POST",
            headers: {
              "Content-Type": "application/json",
