...
const TraditionWisdom = ({ navigation }) => {
  ...
  const fetchWisdomData = async () => {
    try {
      const response = await fetch(`${API_URL}/wisdomhealth.php`);
    ...
    <View style={styles.container}>
      ...
      <View style={styles.searchContainer}>
        <TextInput
          ...
          placeholder="ค้นหาภูมิปัญญาด้านประเพณี..."
          value={searchQuery}
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        {filteredData.map((wisdom) => (
          <TouchableOpacity
            ...
            onPress={() => navigation.navigate('healthDetail', { healthId: wisdom.id })}
          >
...
export default TraditionWisdom;
